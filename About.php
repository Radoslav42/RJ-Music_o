...
<nav class="navbar navbar-dark bg-dark ">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/RJ-Music/Home.php">Domov</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/RJ-Music/About.php">O mne</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-4">
                    <img src="/RJ-Music//Resources/Images/RJ_Music_500x500.png" class="img-fluid" alt="...">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <img src="/RJ-Music//Resources/Images/CakewalkUI.png" class="img-fluid" alt="...">
                </div>
            </div>
        </div>
    </div>
